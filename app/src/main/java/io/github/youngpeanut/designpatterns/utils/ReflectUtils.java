...
package io.github.youngpeanut.designpatterns.utils;
...
public class ReflectUtils {
    ...
    /**
     * http://blog.csdn.net/barryhappy/article/details/24442953
     * @param clz
     * @param fieldName
     * @return
     */
    public static Object getStaticFieldValue(Class clz,String fieldName){
        ...
        Object value = null;
        Field field = getField(clz,fieldName,true,true);
        if (null != field){
    ...
    public static void writeField(Class clz ,String fieldname,String fieldObj,Object newValue){

        Field field = getField(clz,fieldname,true,true);
        if (null != field) {
            field.setAccessible(true);
            try {
                field.set(fieldObj,newValue);
            } catch (IllegalAccessException e) {
                e.printStackTrace();
            }
        }
